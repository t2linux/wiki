...
- **Ubuntu** is not booting using the Mac Startup Manager on **Mac Mini**. Thus Mac Mini users are advised to [install the rEFInd bootloader](https://wiki.t2linux.org/guides/refind/) and boot Ubuntu using it instead of the Startup Manager.
