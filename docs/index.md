...
- Implement MacOS-like Keyboard and clickpad experience on **Gnome Xorg**. Read the top comments of each file to understand requirements, additional tools and usage.
  - [Synaptics Config](https://gist.github.com/smileBeda/f0452f0d7f1f6d8aa772603411f7876f) (for general clickpad behaviour using Synaptics)
