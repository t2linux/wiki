...
- Implement macOS-like Keyboard and trackpad experience on **Gnome Xorg**. Read the top comments of each file the links given below to understand requirements, additional tools and usage.
