...
The best way to donate, we believe, is in the form of skill. If you think you have the potential to help us in pushing the project further, like fixing bugs, adding new features, etc., you are free to do so. For this, you may contact our Matrix Space, or Discord server, where other members of this organization are present.
...
- [AdityaGarg8](https://github.com/AdityaGarg8) - Current maintainer of Ubuntu. Has also helped in writing T2 kernel patches and upstreaming various patches. Donate via [GitHub sponsors](https://github.com/sponsors/AdityaGarg8) or [Buy Me a Coffee](https://www.buymeacoffee.com/gargadityav).
