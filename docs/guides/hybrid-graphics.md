...
2.  Set the AMD GPU Dynamic Power Management level from auto to low or high. Low can be safer option to avoid thermal issues or save battery. *Note this will not work on MacBook 15,1 as the amdgpu driver does not support runtime PM on Polaris cards.*
